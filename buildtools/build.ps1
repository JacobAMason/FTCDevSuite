...
Try {
    ...
    & "./buildtools/makensis.exe" /DINSTALL_TYPE=Net /DPRODUCT_VERSION="1.0.1" /V2 FTCDevSuite.nsi

    echo ""
    Write-Color -Text "Building Full installer (takes ~10m)" -Color "magenta"
    & "./buildtools/makensis.exe" /DINSTALL_TYPE=Full /DPRODUCT_VERSION="1.0.1" /V2 FTCDevSuite.nsi
